  ...
  return (
    <main>
      <section className="mx-auto max-w-6xl px-4 py-16 md:px-8 lg:px-12">
        ...
        <h1 className="mt-3 text-4xl font-semibold text-ink md:text-5xl">Choose a package that fits your stage</h1>
        ...
        {pricing.length ? (
          <div className="mt-10 grid gap-6 md:grid-cols-3">
            {pricing.map((tier: any) => (
              <article key={tier.id} className="rounded-lg border border-stone-200 bg-white p-6">
