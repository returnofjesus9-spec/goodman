export default function WhatsAppCta() {
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 flex items-center gap-2 rounded-full bg-[#25D366] px-4 py-3 text-sm font-semibold text-white shadow-lg shadow-slate-900/20 transition-transform hover:scale-105 md:bottom-8 md:right-8"
    >
