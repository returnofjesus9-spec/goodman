export default function WhatsAppCta() {
  return (
    <a
      ...
      className="fixed bottom-[calc(1.25rem+env(safe-area-inset-bottom))] right-5 z-50 flex items-center gap-2 rounded-full bg-[#25D366] px-4 py-3 text-sm font-semibold text-white shadow-lg shadow-black/50 ring-1 ring-white/10 transition-transform duration-300 ease-out hover:scale-105 md:bottom-8 md:right-8"
    >
